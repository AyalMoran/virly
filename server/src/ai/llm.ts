...
export function buildClassifierPrompt(input: ClassifyAssistantIntentInput)
{
    ...
    return [
        ...
        "- do I have a recipient named Rani?",
        "- who is rani@example.com?",
        "- תחפש לי את דניאל",
        "- יש לי נמען בשם רני?",
        "",
        "recipient_profile:",
        ...
        "- what details do you have for Rani?",
        ...
        "- show transfers to Rani",
        "- what payments did I make to him?",
        "- תראה לי העברות לדני",
        "- אילו עסקאות היו לי מול רני?",
        "",
        ...
        "- summarize my activity with Rani",
        ...
        "- preview transfer to rani@example.com for 40 shekels",
