 ...
 * must become 150, not Rani's 320). The executors live in `worldTools.ts`.
 */
...
export const WORLD = {
  ...
  counterparties: {
    rani: {
      key: "rani", email: "rani@example.com", firstName: "Rani", lastName: "Cohen",
...
export const WORLD_RECENT_TX = [
  { id: "tx-1", direction: "sent" as const, amount: 120, cp: "rani" as const, occurredAt: "2026-06-10T09:00:00.000Z" },
  ...
  { id: "tx-5", direction: "received" as const, amount: 40, cp: "rani" as const, occurredAt: "2026-05-30T09:00:00.000Z" }
];
